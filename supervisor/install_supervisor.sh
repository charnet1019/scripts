...
INST_DIR="/opt"
NODE_EXPORTER_APP_NAME="node_exporter-1.1.2.linux-amd64.tar.gz"
NODE_EXPORTER_APP_BASE_NAME="${NODE_EXPORTER_APP_NAME%.tar*}"
CONSUL_SERVER="10.10.11.62:8500"
STATIC_RESOURCE_SRV="172.18.10.13:58848"
...
install_node_exporter() {
    ...
    cd ${INST_DIR}/src
    wget http://${STATIC_RESOURCE_SRV}/software/monitor/node/${NODE_EXPORTER_APP_NAME}
...
HOST_IP=`ifconfig $(route -n | awk 'NR==3 {print}' | awk '{print $NF}') | grep -w inet | awk '{print $2}'`
